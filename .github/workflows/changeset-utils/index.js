...
const getReleasedPackages = async (pullRequest, github) => {
  ...
  const ignoredFiles = [
    ...
    'src/components/Wds_Topology/**',
    'src/components/BindingPolicy/constants/**',
    'src/components/BindingPolicy/styles/**',
    'src/components/BindingPolicy/Dialogs/**',
  ...
  if (releasedPackages.length === 0) {
    releasedPackages.push('kubestellarui');
  }
